...
- Datasets, diagrams, dashboards, and screenshots
...
|-------------------|---------|----------|
| **TVETMARA Student Attendance Management System** | A Flutter and Firebase application supporting role-based attendance processes | [View project](#) |
| **Azure Data Engineering Tutorial** | A layered cloud data workflow using Azure, PySpark, Parquet, Delta tables, and Power BI | [View tutorial](#) |
| **High-Performance Web Crawler** | Sequential and asynchronous web crawling with performance measurement and PySpark processing | [View project](#) |
| **Business Intelligence Project** | Business-data transformation using Alteryx with dashboard evidence prepared for Power BI | [View project](#) |
| **CO₂ Emissions from Cars** | Python-based data cleaning, merging, visualisation, and introductory machine-learning work | [View project](#) |
| **Pet Hospital Database** | A relational database project covering tables, constraints, queries, joins, subqueries, and indexing | [View project](#) |
| **Koperasi Kakitangan KADA System** | A PHP web application containing member, user, administration, and loan-related functionalities | [View project](#) |
| **Course Registration System** | A Java console application demonstrating object-oriented programming concepts | [View project](#) |
...
- [Portfolio Website](#)
- [GitHub Profile](https://github.com/chohjingyia23cs0296)
- [E-Portfolio Repository](https://github.com/chohjingyia23cs0296/ePortfolio)
- [LinkedIn Profile](#)
